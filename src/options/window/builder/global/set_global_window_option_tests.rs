...
fn set_global_window_option_tests() {
    ...
    use crate::{
        ClockModeStyle, SetGlobalWindowOption, SetUserOption, SetWindowOptionTr, StatusKeys, Switch,
    };
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::aggressive_resize(Some(target), Some(Switch::On)).to_string();
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_3_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::allow_rename(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_2", not(feature = "tmux_3_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::alternate_screen(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")] // 0.8
    {
        ...
        let set_option =
            SetGlobalWindowOption::automatic_rename(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::automatic_rename_format(Some(target), Some("2")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::clock_mode_colour(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_2_9")))]
    {
        ...
        let set_option = SetGlobalWindowOption::force_height(Some(target), Some(1)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_2_9")))]
    {
        ...
        let set_option = SetGlobalWindowOption::force_width(Some(target), Some(2)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_7", not(feature = "tmux_1_8")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::layout_history_limit(Some(target), Some(3)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetGlobalWindowOption::main_pane_height(Some(target), Some(4)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetGlobalWindowOption::main_pane_width(Some(target), Some(5)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::mode_keys(Some(target), Some(StatusKeys::Emacs)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option = SetGlobalWindowOption::mode_style(Some(target), Some("style")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::monitor_activity(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_2_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::monitor_content(Some(target), Some("match-string")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_6")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::monitor_bell(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_4")]
    {
        ...
        let set_option = SetGlobalWindowOption::monitor_silence(Some(target), Some(1)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_4")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::other_pane_height(Some(target), Some(1)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_4")]
    {
        ...
        let set_option = SetGlobalWindowOption::other_pane_width(Some(target), Some(2)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::pane_active_border_style(Some(target), Some("style"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_6")]
    {
        ...
        let set_option = SetGlobalWindowOption::pane_base_index(Some(target), Some(5)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_3")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::pane_border_format(Some(target), Some("format")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_3")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::pane_border_status(Some(target), Some(PaneBorderStatus::Top))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::pane_border_style(Some(target), Some("style")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_3_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::remain_on_exit(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_2", not(feature = "tmux_3_2")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::synchronize_panes(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_2_2")))]
    {
        ...
        let set_option = SetGlobalWindowOption::utf8(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_2_1", not(feature = "tmux_3_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_active_style(Some(target), Some("style")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_bell_attr(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_bell_bg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_bell_fg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_content_attr(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_content_bg(Some(target), Some("colour"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_content_fg(Some(target), Some("colour"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_activity_attr(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_activity_bg(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_6", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_activity_fg(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_attr(Some(target), Some("attributes")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_bg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_fg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_current_attr(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_current_bg(Some(target), Some("colour"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_current_fg(Some(target), Some("colour"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_3", not(feature = "tmux_1_6")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_alert_attr(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_3", not(feature = "tmux_1_6")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_alert_bg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_3", not(feature = "tmux_1_6")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_alert_fg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_activity_style(Some(target), Some("style"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_bell_style(Some(target), Some("style"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_9", not(feature = "tmux_2_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_content_style(Some(target), Some("style"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_2")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_current_format(Some(target), Some("string"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_8", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_last_attr(Some(target), Some("attributes"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_8", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_last_bg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_8", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_last_fg(Some(target), Some("colour")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_current_style(Some(target), Some("style"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_2")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_format(Some(target), Some("string")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_last_style(Some(target), Some("style"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_7")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_separator(Some(target), Some("string"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_status_style(Some(target), Some("style")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_9")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_size(Some(target), Some(WindowSize::Largest)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_1_2", not(feature = "tmux_1_6")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::word_separators(Some(target), Some("string")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(all(feature = "tmux_2_1", not(feature = "tmux_3_0")))]
    {
        ...
        let set_option =
            SetGlobalWindowOption::window_style(Some(target), Some("style")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_7")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::wrap_search(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetGlobalWindowOption::xterm_keys(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }

    {
        ...
        let set_option =
            SetGlobalWindowOption::user_option_ext(Some(target), "user-option-name", Some("value"))
                .to_string();
        assert_eq!(origin, set_option);
    }
}
