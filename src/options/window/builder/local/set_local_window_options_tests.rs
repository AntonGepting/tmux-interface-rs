...
fn set_local_window_options() {
    ...
    use crate::{
        ClockModeStyle, SetLocalWindowOptions, SetUserOptions, SetWindowOptions, StatusKeys, Switch,
    };

    let options = SetLocalWindowOptions::new();
    let target = ":";
