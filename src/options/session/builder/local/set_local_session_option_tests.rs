...
fn set_local_session_option_tests() {
    use crate::{
        Action, Activity, DestroyUnattached, DetachOnDestroy, SetLocalSessionOption,
    ...
    #[cfg(feature = "tmux_2_6")]
    {
        ...
        let set_option =
            SetLocalSessionOption::activity_action(Some(target), Some(Action::Other)).to_string();
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetLocalSessionOption::base_index(Some(target), Some(1)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::bell_action(Some(target), Some(Action::None)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetLocalSessionOption::default_command(Some(target), Some("")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::default_shell(Some(target), Some("/bin/bash")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_2_9")]
    {
        ...
        let set_option =
            SetLocalSessionOption::default_size(Some(target), Some((80, 24))).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_5")]
    {
        ...
        let set_option =
            SetLocalSessionOption::destroy_unattached(Some(target), Some(DestroyUnattached::Off))
                .to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_4")]
    {
        ...
        let set_option =
            SetLocalSessionOption::detach_on_destroy(Some(target), Some(DetachOnDestroy::On))
                .to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_2")]
    {
        ...
        let set_option =
            SetLocalSessionOption::display_panes_active_colour(Some(target), Some("red"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::display_panes_colour(Some(target), Some("blue")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::display_panes_time(Some(target), Some(1000)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        let origin = format!("{} {} {}", cmd, "display-time", "750");
        let set_option = SetLocalSessionOption::display_time(Some(target), Some(750)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        let origin = format!("{} {} {}", cmd, "history-limit", "2000");
        let set_option = SetLocalSessionOption::history_limit(Some(target), Some(2000)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_2_2")]
    {
        let origin = format!("{} {} {}", cmd, "key-table", "root");
        let set_option = SetLocalSessionOption::key_table(Some(target), Some("root")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        let origin = format!("{} {} {}", cmd, "lock-after-time", "0");
        let set_option = SetLocalSessionOption::lock_after_time(Some(target), Some(0)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_1")]
    {
        ...
        let set_option =
            SetLocalSessionOption::lock_command(Some(target), Some("lock -np")).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetLocalSessionOption::message_command_style(Some(target), Some("fg=blue,bg=black"))
                .to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option = SetLocalSessionOption::message_style(
            Some(target),
    ...
    #[cfg(feature = "tmux_2_1")]
    {
        ...
        let set_option = SetLocalSessionOption::mouse(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetLocalSessionOption::prefix(Some(target), Some("C-a")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_6")]
    {
        let origin = format!("{} {} {}", cmd, "prefix2", "None");
        let set_option = SetLocalSessionOption::prefix2(Some(target), Some("None")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_7")]
    {
        ...
        let set_option =
            SetLocalSessionOption::renumber_windows(Some(target), Some(Switch::Off)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        let origin = format!("{} {} {}", cmd, "repeat-time", "500");
        let set_option = SetLocalSessionOption::repeat_time(Some(target), Some(500)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::set_titles(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::set_titles_string(Some(target), Some("#W")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_2_6")]
    {
        ...
        let set_option =
            SetLocalSessionOption::silence_action(Some(target), Some(Action::Other)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        let origin = format!("{} {} {}", cmd, "status", "on");
        let set_option = SetLocalSessionOption::status(Some(target), Some(Status::On)).to_string();
        assert_eq!(origin, set_option);
    }
    //#[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_bg(Some(target), Some("default")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_fg(Some(target), Some("colour12")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_2_9")]
    {
    ...
    #[cfg(feature = "tmux_2_9")]
    {
        ...
        let set_option = SetLocalSessionOption::status_format(
            Some(target),
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetLocalSessionOption::status_interval(Some(target), Some(2)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_justify(Some(target), Some(StatusJustify::Left))
                .to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_keys(Some(target), Some(StatusKeys::Emacs)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_left(Some(target), Some("#(whoami)")).to_string();
        assert_eq!(origin, set_option);
    }
    //#[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_left_length(Some(target), Some(50)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_left_style(Some(target), Some("default")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_7")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_position(Some(target), Some(StatusPosition::Bottom))
                .to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option = SetLocalSessionOption::status_right(Some(target), Some("#[]")).to_string();
        assert_eq!(origin, set_option);
    }
    //#[cfg(all(feature = "tmux_1_0", not(feature = "tmux_1_9")))]
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_right_length(Some(target), Some(50)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_9")]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_right_style(Some(target), Some("default")).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_9")]
    {
    ...
    #[cfg(all(feature = "tmux_1_0", not(feature = "tmux_2_2")))]
    {
        ...
        let set_option =
            SetLocalSessionOption::status_utf8(Some(target), Some(Switch::On)).to_string();
        assert_eq!(origin, set_option);
    }
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let origin = format!("{} ; {}", origin0, origin1);
        let set_option = SetLocalSessionOption::update_environment(
            Some(target),
    ...
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::visual_activity(Some(target), Some(Activity::Off)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_0")]
    {
        ...
        let set_option =
            SetLocalSessionOption::visual_bell(Some(target), Some(Activity::Off)).to_string();
        assert_eq!(origin, set_option);
    }
    //#[cfg(all(feature = "tmux_1_0", not(feature = "tmux_2_0")))]
    ...
    #[cfg(feature = "tmux_1_4")]
    {
        ...
        let set_option =
            SetLocalSessionOption::visual_silence(Some(target), Some(Activity::Off)).to_string();
        assert_eq!(origin, set_option);
    }
    #[cfg(feature = "tmux_1_6")]
    {
        ...
        let set_option = SetLocalSessionOption::word_separators(
            Some(target),
            Some("!\"#$%&'()*+,-./;<=>?@[\\]^`{|}~"),
        )
        .to_string();
