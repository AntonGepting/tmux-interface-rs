...
impl<'a> NewSession<'a> {
    ...
    pub fn width(&mut self, width: usize) -> &mut Self {
        self.0.insert_option(x_KEY, width.to_string());
        self
    }
    ...
    pub fn height(&mut self, height: usize) -> &mut Self {
        self.0.insert_option(y_KEY, height.to_string());
        self
    }
