...
fn parse() {
    ...
    let layout_orig = LayoutCell::new(178, 64, 1, 2, None, LayoutType::TopBottom, Some(vec!(pane2, pane3)));
    ...
    let pane3 = LayoutCell::new(177, 31, 5, 6, Some(3), LayoutType::WindowPane, None);
    let layout_orig = LayoutCell::new(178, 64, 1, 2, None, LayoutType::LeftRight, Some(vec!(pane2, pane3)));
    ...
    let window1 = LayoutCell::new(177, 32, 3, 4, None, LayoutType::LeftRight, Some(vec!(pane1, pane4, pane5)));
    ...
    let window2 = LayoutCell::new(177, 31, 1, 33, None, LayoutType::LeftRight, Some(vec!(pane2, pane3)));
    let layout_orig = LayoutCell::new(178, 64, 1, 2, None, LayoutType::TopBottom, Some(vec!(window1, window2)));
